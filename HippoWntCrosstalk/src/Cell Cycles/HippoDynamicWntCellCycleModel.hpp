/*
 * HippoDynamicWntCellCycleModel.hpp
 *
 *  Created on: 1 Nov 2017
 *      Author: daniel
 */

#ifndef PROJECTS_DANIELW_SRC_CELL_CYCLES_HippoDynamicWntCellCycleModel_HPP_
#define PROJECTS_DANIELW_SRC_CELL_CYCLES_HippoDynamicWntCellCycleModel_HPP_
 ...
 */
class HippoDynamicWntCellCycleModel : public AbstractWntOdeBasedCellCycleModel
{
private:
...
public:
     ...
     */
    HippoDynamicWntCellCycleModel(boost::shared_ptr<AbstractCellCycleModelOdeSolver> pOdeSolver = boost::shared_ptr<AbstractCellCycleModelOdeSolver>());
...
#endif /* PROJECTS_DANIELW_SRC_CELL_CYCLES_HippoDynamicWntCellCycleModel_HPP_ */
